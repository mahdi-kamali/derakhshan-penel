    ...
    <svg
      ...
      <rect
        ...
        <animate
          ...
          attributeName='y'
          begin='0;svgSpinnersBarsScale1.end-0.4s'
          calcMode='spline'
          dur='1s'
      ...
      <rect
        ...
        <animate
          attributeName='y'
          begin='svgSpinnersBarsScale0.begin+0.8s'
          calcMode='spline'
          dur='1s'
          keySplines='.36,.61,.3,.98;.36,.61,.3,.98'
          values='6;1;6'></animate>
      ...
      <rect
        ...
        <animate
          attributeName='y'
          begin='svgSpinnersBarsScale0.begin+1.2s'
          calcMode='spline'
          dur='1s'
          keySplines='.36,.61,.3,.98;.36,.61,.3,.98'
          values='6;1;6'></animate>
      ...
      <rect
        ...
        <animate
          ...
          attributeName='y'
          begin='svgSpinnersBarsScale0.begin+1.6s'
          calcMode='spline'
          dur='1s'
          keySplines='.36,.61,.3,.98;.36,.61,.3,.98'
          values='6;1;6'></animate>
